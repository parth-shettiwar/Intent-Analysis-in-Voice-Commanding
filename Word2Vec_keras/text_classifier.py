...
from exx.tensorflow_examples.lite.model_maker.core.export_format import ExportFormat
from exx.tensorflow_examples.lite.model_maker.core.task import classification_model
# from exx.tensorflow_examples.lite.model_maker.core.task import model_spec as ms
from exx.tensorflow_examples.lite.model_maker.core.task import model_util


def create(train_data,k,
           model_spec=None,
  ...
  text_classifier.train(train_data,k, validation_data, epochs, batch_size)
...
class TextClassifier(classification_model.ClassificationModel):
  ...
  def train(self, train_data,k, validation_data=None, epochs=None, batch_size=32):
    ...
    self.model = self.model_spec.run_classifier(train_input_fn,k,
