...
def dataset(name):
    ...
    word_to_id = tl.nlp.build_vocab(bag_of_words)
    ...
    word_ids_train = tf.convert_to_tensor(word_ids_train.astype(int))
    word_ids_test = tf.convert_to_tensor(word_ids_test.astype(int))
    labels_train = tf.convert_to_tensor(labels_train.astype(int))
    labels_test = tf.convert_to_tensor(labels_test.astype(int))
    # word_ids_train = torch.from_numpy(word_ids_train.astype(int))
    # word_ids_test = torch.from_numpy(word_ids_test.astype(int))
